        ...
        <tr>
            ...
            <td>
                ...
                <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#editGuestModal<?php echo $row['id']; ?>">
                    ...
                    <button type="button" class="btn btn-danger delete-btn" data-bs-toggle="modal" data-bs-target="#deleteGuestModal<?php echo $row['id']; ?>">
...
<div class="modal fade" id="deleteGuestModal<?php echo $row['id']; ?>" tabindex="-1" aria-labelledby="deleteGuestModalLabel<?php echo $row['id']; ?>" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deleteGuestModalLabel<?php echo $row['id']; ?>">Delete Guest</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer">
                ...
                <form method="post" action="../functions/delete-booking.php">
